...
public class MessageInterfaceBuilder {
    ...
    /**
     * @param packageName the package name of the interface or {@code null} if
     * no package name should be specified
...
//                "public interface %s extends org.ros.internal.message.Message {\n", interfaceName));
        ...
        final String definition = messageDeclaration.getDefinition();
        StringTokenizer tokenizer = new StringTokenizer(definition, "\r\n");
        builder.append("  static final java.lang.String _DEFINITION = \"\"\n");
