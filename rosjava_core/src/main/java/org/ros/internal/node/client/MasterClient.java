...
public class MasterClient extends Client<MasterXmlRpcEndpoint> {
     ...
     *
     * @param slave the {@link NodeIdentifier} where the {@link ServiceServer}
     * is running
     ...
     *
     * @param slave the {@link NodeIdentifier} that the {@link Subscriber} is
     * running on
     ...
     *
     * @param publisherDeclaration the {@link PublisherDeclaration} of the
     * {@link Publisher} to register
     ...
     *
     * @param publisherIdentifier the {@link PublisherIdentifier} of the
     * {@link Publisher} to unregister
    ...
    public Response<Integer> unregisterPublisher(PublisherIdentifier publisherIdentifier) {
        ...
        try {
            final List<Object> response = xmlRpcEndpoint.unregisterPublisher(slaveName, topicName, slaveUri);
            return Response.fromListChecked(response,
                    new IntegerResultFactory());
        } catch (RuntimeException exception) {
            throw new RuntimeException("slaveName="+slaveName+",slaveUri="+slaveUri+",topicName="+topicName,exception);
        } 
    }
