...
public class XmlRpcClientFactory<T extends org.ros.internal.node.xmlrpc.XmlRpcEndpoint> {
  ...
  public Object newInstance(ClassLoader pClassLoader, final Class<T> pClass,
      ...
      Exception baseEx = new Exception("pRemoteName="+pRemoteName+",pClass="+pClass);
...
//          if(linkedException instanceof ConnectException) {
//              ConnectException conException = (ConnectException) linkedException;
//              conException.
//          }
            baseEx.printStackTrace();
          throw new RuntimeException("pRemoteName="+pRemoteName+",pClass="+pClass,linkedException);
        }
